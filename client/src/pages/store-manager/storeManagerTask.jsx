...
//   { key: "stores", label: "Manage Stores", icon: <Store size={35} color="white"strokeWidth={1}/>, bg: "bg-cyan-700 shadow-lg shadow-cyan-700/40", path: "/admin/stores" },
  { key: "trips", label: "View Trips", icon: <Road size={35} color="white"strokeWidth={1}/>, bg: "bg-slate-800 shadow-lg shadow-slate-800/40", path: "/stores/view-trips" },
...
{ key: "tracking", label: "Tracking", icon: <MapPinned size={35} color="white"strokeWidth={1}/>, bg: "bg-sky-700 shadow-lg shadow-sky-700/40", path: "/stores/tracking" },
];
...
export default function StoreManagerTasks(){
    return(
      <>
    ...
    <main className="flex-1 flex flex-col items-center justify-center px-6 py-6">
      <div
          className="grid gap-5 w-full grid-cols-1 md:grid-cols-2 max-w-[600px] items-center justify-center"
          // style={{
          //   maxWidth: "600px",
