import { BookUser, Building2, ChartNoAxesCombined, LocateFixed, Road, Settings, UserRound, Siren, Store, Truck, Warehouse, OctagonAlert } from "lucide-react";
...
export const SUPER_ADMIN_TASKS = [
  ...
  { key: "users", label: "Users", icon: <UserRound size={35} color="white"strokeWidth={1}/>, bg: "bg-sky-700 shadow-lg shadow-sky-700/40", path: "/admin/manage-users" },
  ...
  // { key: "devices", label: "GPS Devices", icon: <LocateFixed size={35} color="white"strokeWidth={1}/>, bg: "bg-teal-700 shadow-lg shadow-teal-700/40", path: "/admin/manage-gps-devices" },
   { key: "reports", label: "Reported Issues", icon: <OctagonAlert size={35} color="white"strokeWidth={1}/>, bg: "bg-red-800 shadow-lg shadow-red-800/40", path: "/admin/reports" },
